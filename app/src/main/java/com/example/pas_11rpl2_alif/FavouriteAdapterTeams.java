...
public class FavouriteAdapterTeams extends RecyclerView.Adapter<com.example.pas_11rpl2_alif.FavouriteAdapterTeams.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.pas_11rpl2_alif.FavouriteAdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
