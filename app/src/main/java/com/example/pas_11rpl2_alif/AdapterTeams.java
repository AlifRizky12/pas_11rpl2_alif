...
public class AdapterTeams extends RecyclerView.Adapter<com.example.pas_11rpl2_alif.AdapterTeams.MyViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.pas_11rpl2_alif.AdapterTeams.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final com.example.pas_11rpl2_alif.AdapterTeams.MyViewHolder holder, final int position) {
